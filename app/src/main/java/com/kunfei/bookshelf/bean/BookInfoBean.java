...
public class BookInfoBean implements Cloneable {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // coverUrl = "/storage/emulated/0/lryj.epub";
                    android.util.Log.d("wlDebug", "do cover noteUrl = " + noteUrl);
                    ...
                    android.util.Log.d("wlDebug", "ignored", ignored);
                }
            }
        });
    }
    ...
    public String toString() {
        return "BookInfoBean{" +
                ...
                ", bookInfoHtml='" + bookInfoHtml + '\'' +
                ", chapterListHtml='" + chapterListHtml + '\'' +
                '}';
    }
}